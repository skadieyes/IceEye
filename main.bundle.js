...
var ResumeComponent = (function () {
    ...
    ResumeComponent.prototype.uiViewOpen = function () {
        window.open('https://skadieyes.github.io/cherry-ui/dist');
        this.index = 4;
        this.initBanana();
    };
    ResumeComponent.prototype.uiCodeOpen = function () {
        window.open('https://github.com/skadieyes/cherry-ui');
        this.index = 4;
        this.initBanana();
    };
